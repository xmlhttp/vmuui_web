...
<!--顶部导航开始-->
<div class="topnav">
<a  href="/System.php?s=/System/ManagerPage/BaseInfo.html" class="home">首页</a>><a href="/System.php?s=/System/Down">下载管理</a>><a href="javascript:void(0)">下载列表</a>
</div>
<!--顶部导航结束-->
<div class="cont_info">

<div class="tab_txt">
<div class="tab_tit"><a class="export" href="javascript:alert('功能未开放！')" style="display:none">导出Excel</a>下载列表</div>
...
var	myGridnum=5, //选中框所在的下标
	...
	myGrid.setHeader("ID,文件名称,加入时间,启用,编辑,<a href='javascript:void(0)' onclick='chk_all()'>全选 </a>");
