...
<!--顶部导航开始-->
<div class="topnav">
<a  href="/System.php?s=/System/ManagerPage/BaseInfo.html" class="home">首页</a>><a href="/System.php?s=/System/Net">营销网络管理</a>><a href="javascript:void(0)">营销网络列表</a>
</div>
<!--顶部导航结束-->
<div class="cont_info">
...
var	myGridnum=5, //选中框所在的下标
	myGridmode='/System.php?s=/System/Net/', //模块地址
	myGrid = new dhtmlXGridObject('gridbox'); //新建列表
	myGrid.setImagePath("/Web/System/Public/Tool/codebase/imgs/dhxgrid_material/");
	myGrid.setHeader("ID,地址,发布时间,启用,编辑,<a href='javascript:void(0)' onclick='chk_all()'>全选 </a>");
