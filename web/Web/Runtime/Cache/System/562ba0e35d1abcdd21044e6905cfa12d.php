...
<head >
    <title>Present by Richcomm.com.cn 管理中心 -修改产品</title>
...
<!--顶部导航开始-->
<div class="topnav">
<a  href="/System.php?s=/System/ManagerPage/BaseInfo.html" class="home">首页</a>><a href="/System.php?s=/System/Products">产品列表</a>><a href="javascript:void(0)">修改产品</a>
</div>
<!--顶部导航结束-->
<div class="cont_info">
<div class="tab_txt">
<div class="tab_tit">修改产品</div>
	<form method="post" action="<?php echo U('/System/Products/EditSave',array('id'=>I('get.id')));?>" id="form1" enctype="multipart/form-data">
    ...
    <tr>
		...
		<td align="left"><input type="text" class="input1" onFocus="this.className='input1-bor'" onBlur="this.className='input1'"  style="width:400px" id="newtitle" name="newtitle" value="<?php echo ($info["newtitle"]); ?>"  /> <span style=" margin-left:5px; color:#F00; display:none" id="newtitle_tip">×产品名称不能为空</span></td>
    </tr> 
    <tr>
    ...
    <tr>
      ...
      <td  align="left"><input type="button" class="btn" id="addsave" value="修改产品" style=" width:144px; height:30px" /> 
      </td>
    </tr>
  </table>
  </form>
