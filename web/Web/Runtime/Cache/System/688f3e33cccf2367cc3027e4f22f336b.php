...
<head >
    <title>Present by Richcomm.com.cn 管理中心 - 修改管理员</title>
...
<!--顶部导航开始-->
<div class="topnav">
<a  href="/System.php?s=/System/ManagerPage/BaseInfo.html" class="home">首页</a>><a href="/System.php?s=/System/AdminAll">运营信息</a>><a href="javascript:void(0)">修改管理员</a>
</div>
<!--顶部导航结束-->
<div class="cont_info">
<div class="tab_txt">
<div class="tab_tit">修改管理员</div>
	<form method="post" action="<?php echo U('/System/AdminAll/EditSave',array('id'=>I('get.id')));?>" id="form1">
    ...
    <tr>
      ...
      <td  align="left">
      	<input type="radio" id="adminclass" name="adminclass" value="0" <?php if($sysadmin["adminClass"] == 0): ?>checked="checked"<?php endif; ?> />系统编辑
      	<input type="radio" id="adminclass1" name="adminclass" value="1" style="margin-left:20px;" <?php if($sysadmin["adminClass"] == 1): ?>checked="checked"<?php endif; ?>/>系统总管
      </td>
    </tr>
    <tr>
      <td align="right">生&nbsp;&nbsp;效：</td>
      <td  align="left">
		<input type="radio" id="working" name="working" value="1" <?php if($sysadmin["working"] == 1): ?>checked="checked"<?php endif; ?>/>是
      	<input type="radio" id="working1" name="working" value="0" style="margin-left:20px;" <?php if($sysadmin["working"] == 0): ?>checked="checked"<?php endif; ?>/>否
      </td>
    </tr>
