...
<head >
    <title>Present by Richcomm.com.cn 管理中心 - 文件修改</title>
...
<!--顶部导航开始-->
<div class="topnav">
<a href="/System.php?s=/System/ManagerPage/BaseInfo.html" class="home">首页</a>><a href="/System.php?s=/System/DownAll">文件管理</a>><a href="javascript:void(0)">广告修改</a>
</div>
<!--顶部导航结束-->
<div class="cont_info">
<div class="tab_txt">
<div class="tab_tit">文件修改</div>
    ...
    <tr>
     ...
     <tr>
		...
		<td  align="left" style="height:30px"><input type="file" id="upfile" name="upfile" style=" height:30px;float:left" /><?php if(empty($info['upfile'])): ?><a style=" margin-left:5px; color:#F00; height:30px; line-height:30px; float:left" href="javascript:alert('图片不存在！')">×文件不存在，浏览上传文件</a>
        <?php else: ?>
       		<a style=" margin-left:5px; color:#00F; height:30px; line-height:30px; float:left" target="_blank" href="<?php echo ($info['upfile']); ?>">√点击查看文件，上传后覆盖原文件</a><?php endif; ?></td>
    </tr>
