...
<!--顶部导航开始-->
<div class="topnav">
<a  href="/System.php?s=/System/ManagerPage/BaseInfo.html" class="home">首页</a>><a href="/System.php?s=/System/News">新闻管理</a>><a href="javascript:void(0)">新闻列表</a>
</div>
<!--顶部导航结束-->
<div class="cont_info">

<div class="tab_txt">
<div class="tab_tit"><a class="export" href="javascript:alert('功能未开放！')" style="display:none">导出Excel</a>新闻列表</div>
...
var	myGridnum=6, //选中框所在的下标
	myGridmode='/System.php?s=/System/News/', //模块地址
	myGrid = new dhtmlXGridObject('gridbox'); //新建列表
	myGrid.setImagePath("/Web/System/Public/Tool/codebase/imgs/dhxgrid_material/");
	myGrid.setHeader("ID,新闻标题,查看,发布时间,启用,编辑,<a href='javascript:void(0)' onclick='chk_all()'>全选 </a>");
