...
<head >
    <title>Present by vmuui.com 管理中心 -修改新闻</title>
...
<!--顶部导航开始-->
<div class="topnav">
<a  href="/System.php?s=/System/ManagerPage/BaseInfo.html" class="home">首页</a>><a href="/System.php?s=/System/News">新闻列表</a>><a href="javascript:void(0)">修改新闻</a>
</div>
<!--顶部导航结束-->
<div class="cont_info">
<div class="tab_txt">
<div class="tab_tit">修改新闻</div>
	<form method="post" action="<?php echo U('/System/News/EditSave',array('id'=>I('get.id')));?>" id="form1" enctype="multipart/form-data">
    ...
    <tr>
        ...
        <div class="vmupload" style="width:116px;<?php if(empty($info['img'])): else: ?>background:none<?php endif; ?>">
