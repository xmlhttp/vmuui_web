...
<head >
    <title>Present by vmuui.com 管理中心 - 添加案例</title>
...
<!--顶部导航开始-->
<div class="topnav">
<a  href="/System.php?s=/System/ManagerPage/BaseInfo.html" class="home">首页</a>><a href="/System.php?s=/System/Case">案例列表</a>><a href="javascript:void(0)">添加案例</a>
</div>
<!--顶部导航结束-->
<div class="cont_info">
<div class="tab_txt">
<div class="tab_tit">添加案例</div>
	<form method="post" action="<?php echo U('/System/Case/AddSave');?>" id="form1" enctype="multipart/form-data">
    ...
    <tr>
		...
		<td align="left"><input type="text" class="input1" onFocus="this.className='input1-bor'" onBlur="this.className='input1'"  style="width:400px" id="newtitle" name="newtitle" /> <span style=" margin-left:5px; color:#F00; display:none" id="newtitle_tip">×案例名称不能为空</span></td>
    </tr> 
    
     <tr>
		<td align="right">案例地址：</td>
		<td align="left"><input type="text" class="input1" onFocus="this.className='input1-bor'" onBlur="this.className='input1'"  style="width:400px" id="url" name="url" /></td>
    </tr>
    
     <tr>
		<td align="right">上线时间：</td>
		<td align="left"><input type="text" class="input1" onFocus="this.className='input1-bor'" onBlur="this.className='input1'"  style="width:240px" id="ontime" name="ontime" /></td>
    </tr>
    ...
    <tr>
		...
		<td  align="left" style="height:86px">
         ...
         <div class="vmupload" style="width:75px">
    ...
    <tr>
      ...
      <td  align="left"><input type="button" class="btn" id="addsave" value="添加案例" style=" width:144px; height:30px" /> 
      </td>
    </tr>
  </table>
  </form>
...
$(function(){
	...
	$("#pls").val("|");
	swfu = new SWFUpload({
		upload_url: "<?php echo U('/System/Case/Swfupload');?>",
		post_params: {"cid": "8"},
