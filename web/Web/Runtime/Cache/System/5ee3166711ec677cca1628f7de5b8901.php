...
<div class="tab_tit">修改案例</div>
	<form method="post" action="<?php echo U('/System/Case/EditSave',array('id'=>I('get.id')));?>" id="form1" enctype="multipart/form-data">
    ...
    <tr>
		...
		<td align="left"><input type="text" class="input1" onFocus="this.className='input1-bor'" onBlur="this.className='input1'"  style="width:400px" id="newtitle" name="newtitle" value="<?php echo ($info["newtitle"]); ?>"  /> <span style=" margin-left:5px; color:#F00; display:none" id="newtitle_tip">×案例名称不能为空</span></td>
    </tr> 
      <tr>
		<td align="right">案例地址：</td>
		<td align="left"><input type="text" class="input1" onFocus="this.className='input1-bor'" onBlur="this.className='input1'"  style="width:400px" id="url" name="url"  value="<?php echo ($info["url"]); ?>"/></td>
    </tr>
    
    <tr>
		<td align="right">上线时间：</td>
		<td align="left"><input type="text" class="input1" onFocus="this.className='input1-bor'" onBlur="this.className='input1'"  style="width:240px" id="ontime" name="ontime" value="<?php echo ($info["ontime"]); ?>" /></td>
    </tr>
    ...
    <tr>
        ...
        <div class="vmupload" style="width:75px;<?php if(empty($info['img'])): else: ?>background:none<?php endif; ?>">
        ...
        <div class="vmupload" style="display:none;<?php if(empty($info['bigimg'])): else: ?>background:none<?php endif; ?>">
        <?php if(empty($info['bigimg'])): ?><img class="vmupimg" src="" />
         <?php else: ?>
        	<img class="vmupimg" src="<?php echo ($info['bigimg']); ?>"  style="display:block"/><?php endif; ?>
            <div class="vmsame">
        	<div class="vmuptxt">
            	<div class="vmuptxtbg"></div>
            ...
            <img src="/Web/System/Public/images/swfupload/fancy_close.png" class="vmupclose" <?php if(empty($info['bigimg'])): else: ?> style=" display:block"<?php endif; ?>/>
        </div>
