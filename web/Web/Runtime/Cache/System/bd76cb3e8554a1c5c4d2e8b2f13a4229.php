...
<head >
    <title>Present by Richcomm.com.cn 管理中心 - 添加营销网络</title>
...
<!--顶部导航开始-->
<div class="topnav">
<a  href="/System.php?s=/System/ManagerPage/BaseInfo.html" class="home">首页</a>><a href="/System.php?s=/System/Net">营销网络列表</a>><a href="javascript:void(0)">添加营销网络</a>
</div>
<!--顶部导航结束-->
<div class="cont_info">
<div class="tab_txt">
<div class="tab_tit">添加营销网络</div>
	<form method="post" action="<?php echo U('/System/Net/AddSave');?>" id="form1" enctype="multipart/form-data">
    ...
    <tr>
      ...
      <td  align="left"><input type="button" class="btn" id="addsave" value="添加营销网络" style=" width:144px; height:30px" /> 
      </td>
    </tr>
  </table>
  </form>
